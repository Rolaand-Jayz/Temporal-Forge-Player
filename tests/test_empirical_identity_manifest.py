"""Empirical identity manifest contract tests.
...
from benchmarks.empirical.experiment_identity import (
    IdentityError,
    binary_identity,
...
class Sha256Tests(unittest.TestCase):
    def test_sha256_file_matches_reference_hash(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            payload = b"temporal forge empirical identity payload"
...
def _write_trace(path: Path, **overrides: str) -> Path:
    trace = {
        ...
        "run_id": overrides.get("run_id", "EVS-TEST"),
    }
