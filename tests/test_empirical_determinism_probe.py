"""Empirical R2 contract: determinism probe verifier and PPM metric semantics.
...
from benchmarks.empirical.determinism_probe import (
    MAE_THRESHOLD,
    ppm_mae,
    read_ppm,
    verify_determinism,
