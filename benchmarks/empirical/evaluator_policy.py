"""Empirical evaluator policy and negative controls.

Schema ``temporal_forge.empirical.evaluator.v1``. The evaluator decides whether a
...
Rejection rules (each is a Empirical negative control):
...
from benchmarks.empirical.determinism_probe import read_ppm

SCHEMA = "temporal_forge.empirical.evaluator.v1"
...
def phase_sanity(
    ...
    a Empirical evaluator self-check, not a candidate verdict.
    """
