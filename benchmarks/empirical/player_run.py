"""Empirical controlled player launcher.

One place owns the launch recipe so every Empirical capture has identical
...
def run_player(
    ...
    # Every Empirical capture carries the per-frame state-generation trace so
