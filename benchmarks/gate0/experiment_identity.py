"""Gate-0 experiment identity manifest.

Schema ``temporal_forge.gate0.identity.v1``: the complete, verifiable identity
...
SCHEMA = "temporal_forge.gate0.identity.v1"
...
def build_manifest(
    ...
    """Assemble the complete Gate-0 identity manifest for one experiment."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Build a Gate-0 experiment identity manifest."
    )
